      ...
      <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
        <div className={`${styles.flexStart} md:flex-row flex-col mb:8 w-full`}>
          <div className='flex-1 flex flex-col justify-start mr-10'>
            <img src={logo} alt="hoiobank" className='w-[266px] h-[72px] object-contain' />
            <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>A new way to make the payments easy, reliable and secure.</p>
          </div>
          <div className='flex-[1.5] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10'>
            {footerLinks.map((footerLink) => (
              <div key={footerLink.title} clasName='flex flex-col ss:my-0 my-4 min-w-[150px]'>
        ...
        <div className='w-full flex mt-6 md:flex-row flex-col items-center justify-between pt-6 border-t-[1px] border-t-[#3f3e45]'>
